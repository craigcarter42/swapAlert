...
''' swapAlert: Version 1.3 box256: Track swapfiles that are being
generated by the OS when wired memory is nearly reached max '''
...
# This method returns 0 if both dictionaries are equal, -1 if dict1 < dict2 and 1 if dict1 > dic2.
	compared_swaps = cmp (current_swaps, read_pl)
	if(compared_swaps == 0):
		print(" -- swapAlert: no changes have occured")
	elif(compared_swaps == -1):
		print(" -- swapAlert: current_swaps is less than read_pl")
	elif(compared_swaps == 1):
		print(" -- swapAlert: read_pl is greater than current_swaps")
	else:
		print(" -- swapAlert: comparison could not be completed")
